...
<script type="text/javascript">
	...
	function register(){
		...
		if(user==""|| pass==""){
			//alert("请输入用户名和密码!");
			var spanElement = document.getElementById("passSpan");
			spanElement.innerHTML = "<font size='2' color='red'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;请输入用户名或密码!!</font>";
			return false;
...
<body>
 <div class="a1">
<b><p align="center"><font size="3" color="red">管理员注册</font></p></b>
	<form action="add_user.do" method="post" onsubmit="return register()" enctype="application/x-www-form-urlencoded">
